...
- [ ] 36-06-PLAN.md — Add v1→v3 chained migrateEnvelope regression test (HOUSE-09)
- [ ] 36-07-PLAN.md — Re-archive v1.5 phase dirs to .planning/milestones/v1.5-phases/ (HOUSE-10)
