...
- [ ] 50-05-PLAN.md — useAmbientScale migration: performance.now() → wallClock.now(); INHALE_SEC/EXHALE_SEC rename (Wave 2, autonomous; ABSTR-03 + ABSTR-04)
...
| 50. SessionClock / scheduler abstraction | 4/7 | In Progress|  |
