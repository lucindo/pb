...
- 🚧 **v2.2 Audio Sync** — Phases 49–53 (in progress, started 2026-05-27)

## Phases

### v2.2 Audio Sync (Phases 49–53)

- [ ] **Phase 49: iOS speaker route fix** — Silent looping `<audio playsInline>` on the user-gesture chain coerces iOS Safari from "ambient" to "playback" audio session category so audio plays through the speaker even with the silent switch ON
