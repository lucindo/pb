...
- 🔨 **v1.5 Multi-Practice** — Phases 30–35 (in progress)

## Phases

### v1.5 Multi-Practice (Phases 30–35)
...
- [x] **Phase 33: Close gap — PRACTICE-02 resonant settings persistence** (1/1 plans) - Retarget the resonant-settings read path to the per-practice envelope, remove the dead flat-field `loadSettings`/`saveSettings`, add remount regression tests
- [x] **Phase 34: Stretch as a Distinct Practice** (11/11 plans) - Promote HRV's Stretch mode to a top-level practice — 3-practice switcher (HRV · Stretch · Navi), per-practice settings/stats, v2→v3 migration, A/B switcher treatment
- [x] **Phase 35: Flute Cue Timbre** (2/2 plans) - Replace the Chime timbre with a distinct Flute — soft-attack envelope mode, `chime → flute` rename, legacy storage coercion
...
| 33. Close gap — PRACTICE-02 resonant settings persistence | 1/1 | Complete | 2026-05-18 |
| 34. Stretch as a Distinct Practice | 11/11 | Complete | 2026-05-19 |
| 35. Flute Cue Timbre | 2/2 | Complete | 2026-05-19 |
