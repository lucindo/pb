...
Plans:
- [x] 20-01-PLAN.md — Swap primary button label to Cancel/Cancelar during lead-in (LEAD-01)
...
- [x] 21-02-PLAN.md — useFavicon hook + index.html pre-paint favicon extension + App.tsx mount + human-verify (FAVI-01, FAVI-02, FAVI-03)
...
Plans:
**Wave 1**
- [x] 22-01-PLAN.md — Stretch settings schema, predicates, validation + stretchRamp.ts ramp engine (segment table, frame lookup, gate predicate) (STRETCH-02..06)
