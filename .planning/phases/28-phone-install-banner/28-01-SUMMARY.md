...
- `UiStrings` interface: `readonly install` sub-object added immediately after `learn` with exactly 7 `readonly string` fields: `bannerText`, `installButton`, `iosStepsButton`, `dismiss`, `iosStep1`, `iosStep2`, `iosStep3`.
