...
// clones (theme / breathingShape / ringCue / orbIdle / switcherIcon /
// bypassSilentMode), which differed only by key + type.
//
...
// listeners (useTheme, useVisualCue, useFeatureFlags) filter on detail.key.
//
